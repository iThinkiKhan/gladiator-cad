...
- leaves 8.0 mm between that floor and the PCB underside;
...
- carries its load on two M3 bolts in the rear ends of the long deck slots;
...
2. Put M3 screws and ordinary washers down through the 3.6 mm top holes at
   `(25.5, 130.5)` and `(53.5, 130.5)`, then through the long deck slots. Use
   washers/nuts below the deck. These are the primary anchors.
...
- The current vertical budget permits **15.2 mm above the PCB top** before the
...
- The floor is 0.7 mm above the recorded battery envelope and provides exactly
  8.0 mm for solder/leads below the PCB. Verify no lead exceeds 8.0 mm.
